...
{ 
	uint32_t vga_color;
		switch(color){
			case WHITE  :{vga_color = 8;break;}
			case BLACK  :{vga_color = 7;break;}
			case BLUE   :{vga_color = 5;break;}
			case BRED   :{vga_color = 0;break;}
			case GRED   :{vga_color = 0;break;}
			case GBLUE  :{vga_color = 5;break;}
			case RED    :{vga_color = 0;break;}				
			case GREEN  :{vga_color = 3;break;}
			case CYAN   :{vga_color = 4;break;}
			case YELLOW :{vga_color = 2;break;}
			case BROWN  :{vga_color = 1;break;}				
			case BRRED  :{vga_color = 0;break;}
			case GRAY   :{vga_color = 9;break;}
			default     :{vga_color = 7;break;}
			}
  VGA_print(sx,sy,ex,ey,vga_color);	
...
void LCD_ShowString(uint16_t x,uint16_t y,uint16_t width,uint16_t height,uint8_t size,uint8_t *p)//uint8_t *p
{         
	uint8_t x0=x;
	width+=x;
	height+=y;
